...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		...
		\begin{itemize}
			\item \lstinline{#pragma GCC optimize ("Ofast, unroll-loops")} will make GCC auto-vectorize for loops and optimizes floating points better (assumes associativity and turns off denormals).
...
\section{Other languages}
	...
	\kactlimport{EgorAllocator.h}
	\kactlimport{EgorJava1.java}
	\kactlimport{EgorEulerPath.h}
	% \kactlimport{EgorJava2.java}
